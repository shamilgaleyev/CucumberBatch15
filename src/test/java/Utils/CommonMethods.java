...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofMillis(Constans.WAIT_TIME));
    ...
    public static byte[] takeScreenshot(String imageName)
    {
        ...
        try {
            FileUtils.copyFile(sourcePath, new File(Constans.SCREENSHOT_FILEPATH+imageName+getTimeStamp("yyyy-MM-dd-HH-mm-ss")+".png"));
        } catch (IOException e) {
