...
import Utils.APIPayloadContstants;
...
public class APIWorkflowSteps {
    ...
    public void a_request_is_prepared_to_create_an_employee() {
       request= given().
               ...
               body(APIPayloadContstants.createEmployeePayload());
    }
//another request making with json payload
    ...
    public void a_request_is_prepared_to_create_an_employee_using_json_payload() {
        request = given().
                ...
                .body(APIPayloadContstants.createEmployeePayloadJson());
    ...
    public void the_status_code_for_creating_an_employee_is(Integer int1) {
        //argument/value is comming from feature file
    ...
    @Then("the employee id {string} is stored as a global varibal to be used for other calls")
    public void the_employee_id_is_stored_as_a_global_varibal_to_be_used_for_other_calls(String string) {
        //storying employee_id in global veriable
    ...
    @Given("a request is prepared to create an employee whith dinamic data {string}, {string}, {string}, {string}, {string}, {string}, {string}")
    public void a_request_is_prepared_to_create_an_employee_whith_dinamic_data
        ...
        request= given().
                header(APIConstants.HEADER_KEY_CONTENT_TYPE,
                        APIConstants.HEADER_VALUE_CONTENT_TYPE).
                header(APIConstants.HEADER_KEY_AUTHORIZATION,GenerateTokenSteps.token).
                body(APIPayloadContstants.createEmployeePayloadDynamic(
    ...
    public void a_request_is_prepared_to_update_an_employee() {
        request= given().
                header(APIConstants.HEADER_KEY_CONTENT_TYPE,APIConstants.HEADER_VALUE_CONTENT_TYPE).
                header(APIConstants.HEADER_KEY_AUTHORIZATION,GenerateTokenSteps.token).
                body(APIPayloadContstants.updateEmployeePayloadJson());
    }
